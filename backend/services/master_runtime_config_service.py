...
class MasterRuntimeConfigService:
    ...
    SETTINGS_CATALOG: tuple[SettingSpec, ...] = (
        ...
        SettingSpec(
            key="payments.mp.plan_id_essencial_monthly",
            category="payments",
            env_key="MP_PLAN_ID_ESSENCIAL_MONTHLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Essencial mensal (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
            key="payments.mp.plan_id_essencial_yearly",
            category="payments",
            env_key="MP_PLAN_ID_ESSENCIAL_YEARLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Essencial anual (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
            key="payments.mp.plan_id_profissional_monthly",
            category="payments",
            env_key="MP_PLAN_ID_PROFISSIONAL_MONTHLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Profissional mensal (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
            key="payments.mp.plan_id_profissional_yearly",
            category="payments",
            env_key="MP_PLAN_ID_PROFISSIONAL_YEARLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Profissional anual (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
            key="payments.mp.plan_id_avancado_monthly",
            category="payments",
            env_key="MP_PLAN_ID_AVANCADO_MONTHLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Avançado mensal (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
            key="payments.mp.plan_id_avancado_yearly",
            category="payments",
            env_key="MP_PLAN_ID_AVANCADO_YEARLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="ID do plano Avançado anual (preapproval_plan) no Mercado Pago",
        ),
        SettingSpec(
