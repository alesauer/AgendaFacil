...
class MasterRuntimeConfigService:
    ...
    SETTINGS_CATALOG: tuple[SettingSpec, ...] = (
        ...
        SettingSpec(
            key="payments.stripe.secret_key",
            category="payments",
        ...
        SettingSpec(
            key="payments.stripe.webhook_secret",
            category="payments",
            ...
            validator="stripe_webhook",
        ),
        SettingSpec(
            key="payments.stripe.price_id_monthly",
            category="payments",
            env_key="STRIPE_PRICE_ID_MONTHLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="Price ID mensal da Stripe",
        ),
        SettingSpec(
            key="payments.stripe.price_id_yearly",
            category="payments",
            env_key="STRIPE_PRICE_ID_YEARLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="Price ID anual da Stripe",
        ),
        SettingSpec(
            key="payments.stripe.webhook_barbearia_slug",
            category="payments",
            env_key="STRIPE_WEBHOOK_BARBEARIA_SLUG",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="Slug fallback para resolução de tenant no webhook Stripe",
        ),
        SettingSpec(
            key="payments.stripe.payment_link_monthly",
            category="payments",
            env_key="STRIPE_PAYMENT_LINK_MONTHLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="Link de pagamento mensal da Stripe",
            validator="url",
        ),
        SettingSpec(
            key="payments.stripe.payment_link_yearly",
            category="payments",
            env_key="STRIPE_PAYMENT_LINK_YEARLY",
            data_type="string",
            is_secret=False,
            requires_restart=False,
            description="Link de pagamento anual da Stripe",
            validator="url",
        ),
    )
