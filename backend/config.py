...
def _hydrate_from_env(config_cls):
    ...
    config_cls.BYPASS_PROXY_FOR_SUPABASE = os.getenv("BYPASS_PROXY_FOR_SUPABASE", "true").lower() == "true"
    config_cls.DISABLE_SYSTEM_PROXY_FOR_SUPABASE = os.getenv("DISABLE_SYSTEM_PROXY_FOR_SUPABASE", "true").lower() == "true"
