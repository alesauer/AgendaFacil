...
def send_support_contact_email():
    ...
    metadata = {
        ...
        "stripe.customer_id": subscription.get("stripe_customer_id"),
        "stripe.subscription_id": subscription.get("stripe_subscription_id"),
        "stripe.price_id": subscription.get("stripe_price_id"),
        "stripe.last_event_id": subscription.get("stripe_last_event_id"),
        "stripe.last_event_type": subscription.get("stripe_last_event_type"),
        "stripe.last_event_at": subscription.get("stripe_last_event_at"),
        "stripe.webhook_updated_at": subscription.get("stripe_webhook_updated_at"),
